...
uint32_t F_SYMBOL(crc32)(const uint8_t *s, uint32_t len, int32_t type)
{
	...
	switch (type) {
		case CRC32_DEFAULT_MSB_TYPE:
			c = F_SYMBOL(crc32_msb)(crc32_table_m, b, s, len);
			return c ^ e;
		case CRC32_DEFAULT_LSB_TYPE:
			c = F_SYMBOL(crc32_lsb)(crc32_table_l, b, s, len);
			return c ^ e;
		case CRC32_CASTAGNOLI_MSB_TYPE:
			c = F_SYMBOL(crc32_msb)(crc32_table_mc, b, s, len);
			return c ^ e;
		case CRC32_CASTAGNOLI_LSB_TYPE:
			c = F_SYMBOL(crc32_lsb)(crc32_table_lc, b, s, len);
			return c ^ e;
		case CRC32_KOOPMAN_MSB_TYPE:
			c = F_SYMBOL(crc32_msb)(crc32_table_mk, b, s, len);
			return c ^ e;
		case CRC32_KOOPMAN_LSB_TYPE:
			c = F_SYMBOL(crc32_lsb)(crc32_table_lk, b, s, len);
			return c ^ e;
		case CRC32_Q_MSB_TYPE:
			c = F_SYMBOL(crc32_msb)(crc32_table_mq, 0, s, len);
			return c;
		case CRC32_Q_LSB_TYPE:
			c = F_SYMBOL(crc32_lsb)(crc32_table_lq, 0, s, len);
			return c;
		case CRC32_CKSUM_MSB_TYPE:
			c = F_SYMBOL(crc32_msb)(crc32_table_m, 0, s, len);
			return F_SYMBOL(crc32_cksum_size_msb)(crc32_table_m,
				c, len);
		default:
			return 0;
	}
